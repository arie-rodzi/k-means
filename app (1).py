...
st.set_page_config(page_title="K-Means + PCA Clustering", layout="wide")

st.title("📊 K-Means Clustering with Elbow Method and PCA")
st.markdown("Upload a clean Excel file with numeric features only. The app will detect optimal K, perform clustering, and show PCA.")
...
if uploaded_file:
    ...
    if selected_cols:
        ...
        ax2.set_title("PCA 2D Clustering View")
        ax2.legend()
        st.pyplot(fig2)
        ...
        st.download_button("⬇️ Download Excel with Clusters and PCA", data=output.getvalue(), file_name="clustered_result.xlsx")
